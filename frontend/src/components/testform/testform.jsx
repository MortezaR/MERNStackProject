                                    ...
                                    <div className="lobby-room-header-wrapper">
                                        <div className="lobby-room-header-wrapper-content">
                                            ...
                                            <div className="lobby-room-options">
                                                ...
                                                <a onClick={this.toggleMapsDropdown}><i class="fas fa-ellipsis-h fa-lg"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            </header>
                            <div className="lobby-room-body">
                                {
                                    this.state.messages.map((message, i) => {
                                        ...
                                        return (
                                            <LobbyChatMessage messageFromSameuser={messageFromSameuser} currentUser={this.props.currentUser} message={message} index={i} roomName={this.state.myRoomName} />
                                        )
                                    })
                                }
                            </div>
